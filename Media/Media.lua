...
R.media = {
    ...
    textures = {
        ...
        actionBars = {
            ...
            mainMenuBarBackgroundAlliance = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-Background-Alliance",
            mainMenuBarBackgroundHorde = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-Background-Horde",
            mainMenuBarBackgroundMechanical = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-Background-Mechanical",
            mainMenuBarBackgroundStone = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-Background-Stone",
            mainMenuBarBackgroundTree = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-Background-Tree",
            mainMenuBarBackgroundWood = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-Background-Wood",
            mainMenuBarEndCapGryphon = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Gryphon",
            mainMenuBarEndCapLion = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Lion",
            mainMenuBarEndCapAlliance = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Alliance",
            mainMenuBarEndCapHorde = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Horde",
            mainMenuBarEndCapMechanical = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Mechanical",
            mainMenuBarEndCapStone = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Stone",
            mainMenuBarEndCapTree = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Tree",
            mainMenuBarEndCapWood = MEDIA_PREFIX .. "\\Textures\\ActionBars\\MainMenuBar-EndCap-Wood",
