...
function S:StyleWorldMapFrame()
    local scale = R.config.db.profile.modules.skins.worldMap.scale
    local movingOpacity = R.config.db.profile.modules.skins.worldMap.movingOpacity
    local stationaryOpacity = R.config.db.profile.modules.skins.worldMap.stationaryOpacity
