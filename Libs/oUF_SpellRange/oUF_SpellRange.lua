...
HelpIDs = ( {
	DRUID = { 5185 }; -- Healing Touch (40yd) - Lvl 1
	-- HUNTER = {};
	MAGE = { 475 }; -- Remove Curse (40yd) - Lvl 29
	PALADIN = { 635 }; -- Holy Light (40yd) - Lvl 1
	PRIEST = { 2060 }; -- Lesser Heal (40yd) - Lvl 1
	-- ROGUE = {};
	SHAMAN = { 8004 }; -- Healing Wave (40yd) - Lvl 1
...
HarmIDs = ( {
	...
	HUNTER = { 75 }; -- Auto Shot (8-41yd) - Lvl 1
	MAGE = { 133 }; -- Fireball (36-41yd) - Lvl 1
	-- PALADIN = { 62124 }; -- Reckoning (30yd) - Lvl 15
	PRIEST = { 585 }; -- Smite (30-36yd) - Lvl 1
	-- ROGUE = {};
	SHAMAN = { 403 }; -- Lightning Bolt (30-36yd) - Lvl 1
	WARLOCK = { 686 }; -- Shadow Bolt (30-36yd) - Lvl 1
	-- WARRIOR = { 2480, 7918, 7919 }; -- Shoot
} )[ Class ];
