    ...
    for i = 1, button:GetNumRegions() do
        ...
        if region.IsObjectType and region:IsObjectType("Texture") then
            ...
            if textureID == 136430 or texture == "Interface\\Minimap\\MiniMap-TrackingBorder" then
                ...
                region:SetTexture(R.media.textures.minimapButtonBorder)
...
function MM:StyleMinimap()
    ...
    -- Minimap
    Minimap:SetMaskTexture(R.media.textures.minimapMask1)
    ...
    MiniMapTrackingBorder:SetTexture(R.media.textures.minimapButtonBorder)
