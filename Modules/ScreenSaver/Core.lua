...
function SS:OnEnable()
    ...
    SS.Canvas.Bottom.Border:SetTexture(Addon.media.textures.BorderNormal)
    ...
    SS.Canvas.Bottom.BorderShadow:SetTexture(Addon.media.textures.BorderShadow)
    ...
    local factionGroup, size, offsetX, offsetY, nameOffsetX, nameOffsetY = Addon.PlayerFaction, 140, -20, -16, -10, -28
    ...
    local classColor = _G.RAID_CLASS_COLORS[Addon.PlayerClass]
    SS.Canvas.Bottom.Name = SS.Canvas.Bottom:CreateFontString(nil, "OVERLAY")
    SS.Canvas.Bottom.Name:SetFont(unpack(SS.config.db.profile.font))
    SS.Canvas.Bottom.Name:SetFormattedText("%s-%s", Addon.PlayerName, Addon.PlayerRealm)
    ...
    SS.Canvas.Bottom.Guild:SetFont(unpack(SS.config.db.profile.font))
    ...
    SS.Canvas.Bottom.Time:SetFont(unpack(SS.config.db.profile.font))
