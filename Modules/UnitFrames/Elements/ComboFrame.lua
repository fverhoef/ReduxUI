...
UF.CreateComboFrame = function(self)
    if (Addon.PlayerClass ~= "ROGUE" and Addon.PlayerClass ~= "DRUID") then
        return
    end
    ...
    self.ComboFrame.Background:SetTexture(Addon.media.textures.ComboFrameBackground)
    ...
    for i = 1, 5 do
        ...
        comboPoint.Background:SetTexture(Addon.media.textures.ComboPoint)
        ...
        comboPoint.Highlight:SetTexture(Addon.media.textures.ComboPoint)
        ...
        comboPoint.Shine:SetTexture(Addon.media.textures.ComboPoint)
