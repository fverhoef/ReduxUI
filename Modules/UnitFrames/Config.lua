...
local DEFAULT_UNIT_CONFIG = {
    ...
    trinket = {enabled = false, size = {42, 42}, point = {"LEFT", "RIGHT", 0, 0}},
    diminishingReturnsTracker = {enabled = false, size = {145, 24}, iconSize = 24, iconSpacing = 5, point = {"LEFT", "RIGHT", 0, 0}}
}
