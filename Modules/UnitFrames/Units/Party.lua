...
function UF:SpawnParty()
    local config = UF.config.db.profile.party
    ...
    if config.enabled then
        ...
        Addon:CreateDragFrame(partyHeader, "Party", default.point, 200, 40)
...
function UF:CreateParty()
    ...
    self.Texture:SetTexture(Addon.media.textures.PartyFrame)
