...
function AB:UpdateMainMenuBarTextures()
    ...
    if config.theme == AB.themes.Default then
        ...
        AB.bars.MainMenuBar.LeftEndCap:SetTexture(R.media.textures.actionBars.mainMenuBar)
        ...
        AB.bars.MainMenuBar.RightEndCap:SetTexture(R.media.textures.actionBars.mainMenuBar)
