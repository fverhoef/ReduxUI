...
function S:StyleWorldMapFrame()
    local scale = S.config.db.profile.worldMap.scale
    local movingOpacity = S.config.db.profile.worldMap.movingOpacity
    local stationaryOpacity = S.config.db.profile.worldMap.stationaryOpacity
