...
function S:StyleGuildFrame()
    ...
    Addon:OffsetFrame(GuildMemberDetailName, 30, 0)
    Addon:OffsetFrame(GuildMemberDetailZoneLabel, -30, 0)
    ...
    S:SecureHook("GuildStatus_Update", function()
        ...
        if FriendsFrame.playerStatusFrame then
            for i = 1, GUILDMEMBERS_TO_DISPLAY, 1 do
                ...
                classFileName = Addon:UnlocalizedClassName(class)
