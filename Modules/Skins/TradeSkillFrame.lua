...
function S:StyleTradeSkillFrame()
    ...
    if R.isClassic then
        regions[2]:SetTexture(S.config.tradeSkill.style == S.Styles.Modern and R.media.textures.frames.modern.dualPaneFrame_Left or R.media.textures.frames.vanilla.dualPaneFrame_Left)
        regions[2]:SetTexCoord(0, 1, 0, 1)
        regions[2]:SetSize(512, 512)
        regions[3]:SetTexture(S.config.tradeSkill.style == S.Styles.Modern and R.media.textures.frames.modern.dualPaneFrame_Right or R.media.textures.frames.vanilla.dualPaneFrame_Right)
        regions[3]:SetTexCoord(0, 1, 0, 1)
        regions[3]:SetSize(256, 512)
        regions[3]:ClearAllPoints()
        regions[3]:SetPoint("TOPLEFT", 512, 0)
