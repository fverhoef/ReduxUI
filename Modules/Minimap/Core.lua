...
function MM:UpdateButtonFrame(radius, width)
    ...
    if MM.config.style == MM.Styles.Vanilla then
        ...
        Minimap.ButtonFrameToggleButton:SetNormalTexture(R.media.textures.minimap.vanilla.starButton_Up)
        Minimap.ButtonFrameToggleButton:SetPushedTexture(R.media.textures.minimap.vanilla.starButton_Down)
