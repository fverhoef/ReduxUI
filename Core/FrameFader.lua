...
function Addon:StartFadeIn(frame, config)
...
function Addon:StartFadeOut(frame, config)
...
local function FrameHandler(frame)
    if MouseIsOver(frame) then
        Addon:StartFadeIn(frame)
    else
        Addon:StartFadeOut(frame)
    end
end
...
function Addon:CreateFrameFader(frame, faderConfig)
...
function Addon:CreateButtonFrameFader(frame, buttonList, faderConfig)
    if frame.faderConfig then
        return
    end

    Addon:CreateFrameFader(frame, faderConfig)
