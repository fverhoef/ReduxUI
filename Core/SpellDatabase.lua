...
function SD:ModifyTooltip(tooltip, spellId)
    local rank = SD:GetSpellById(spellId)
...
function Database:UpdateValues(rank)
    local power = (rank.spell.isHeal and CS.healingPower) or
                      (rank.spell.isDamage and (rank.spell.school == Database.Schools.Arcane and CS.spellPower.arcane) or
                          (rank.spell.school == Database.Schools.Fire and CS.spellPower.fire) or (rank.spell.school == Database.Schools.Frost and CS.spellPower.frost) or
                          (rank.spell.school == Database.Schools.Holy and CS.spellPower.holy) or (rank.spell.school == Database.Schools.Shadow and CS.spellPower.shadow) or
                          (rank.spell.school == Database.Schools.Nature and CS.spellPower.nature)) or 0
    local multiplier = (rank.spell.isHeal and CS.healingDone) or
                           (rank.spell.isDamage and (rank.spell.school == Database.Schools.Arcane and CS.spellDamage.arcane) or
                               (rank.spell.school == Database.Schools.Fire and CS.spellDamage.fire) or (rank.spell.school == Database.Schools.Frost and CS.spellDamage.frost) or
                               (rank.spell.school == Database.Schools.Holy and CS.spellDamage.holy) or
                               (rank.spell.school == Database.Schools.Shadow and CS.spellDamage.shadow) or
                               (rank.spell.school == Database.Schools.Nature and CS.spellDamage.nature)) or 1
