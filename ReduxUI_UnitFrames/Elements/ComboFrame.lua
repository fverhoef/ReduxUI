...
UF.CreateComboFrame = function(self)
    ...
    self.ComboFrame.Background:SetTexture(R.media.textures.ComboFrameBackground)
    ...
    for i = 1, 5 do
        ...
        comboPoint.Background:SetTexture(R.media.textures.ComboPoint)
        ...
        comboPoint.Highlight:SetTexture(R.media.textures.ComboPoint)
        ...
        comboPoint.Shine:SetTexture(R.media.textures.ComboPoint)
