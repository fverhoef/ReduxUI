...
UF.CreateThreatIndicator = function(self)
    ...
    if unit == "player" then
        ...
        self.ThreatIndicator:SetTexture(R.media.textures.TargetFrame_Flash)
    ...
    elseif unit == "pet" then
        ...
        self.ThreatIndicator:SetTexture(R.media.textures.PartyFrame_Flash)
    ...
    elseif unit:match("nameplate") then
        ...
        self.ThreatIndicator:SetTexture(R.media.textures.Nameplate_Flash)
        self.ThreatIndicator.feedbackUnit = "player"
    end
