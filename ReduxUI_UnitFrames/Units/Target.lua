...
function UF:CreateTarget()
    ...
    self.EliteTexture:SetTexture(R.media.textures.TargetFrame_Elite)
    self.RareTexture = self:CreateTexture("$parentFrameRareTexture", "ARTWORK")
    self.RareTexture:SetTexture(R.media.textures.TargetFrame_Rare)
    self.RareEliteTexture = self:CreateTexture("$parentFrameRareEliteTexture", "ARTWORK")
    self.RareEliteTexture:SetTexture(R.media.textures.TargetFrame_RareElite)
    ...
    if self then
        ...
        if UF:IsBlizzardTheme() then
            ...
            if R.config.db.profile.modules.unitFrames.theme == UF.themes.Blizzard_LargeHealth then
                ...
                self.Texture:SetTexture(R.media.textures.TargetFrame_LargerHealth)
            else
                ...
                self.Texture:SetTexture(R.media.textures.TargetFrame)
            end
